...
from preprocessing.load import df_numerical_train, df_numerical_test
...
if __name__ == "__main__":
    # Set up 
    nb_raw = df_numerical_test.shape[0]
    nb_col = df_numerical_test.shape[1]
    
    df_numerical_cleaned_test = dataset_numerical_cleaner(df_numerical_test)
        
    check_high_correlations(df_numerical_cleaned_test)
    print(df_numerical_cleaned_test.shape)
