from preprocessing.grouped import df_grouped_cleaned_train, df_grouped_cleaned_test
from preprocessing.numerical import df_numerical_cleaned_train, df_numerical_cleaned_test
from helper_functions.print import *
from preprocessing.load import df_numerical_train, df_grouped_train, df_train, df_numerical_test, df_grouped_test, X_test
...
if __name__ == "__main__":
    ...
    output_filename = "X_numerical_grouped_cleaned_test.csv"
    print(orange("-"*10 + f" Saving to {output_filename} " + "-"*10))
