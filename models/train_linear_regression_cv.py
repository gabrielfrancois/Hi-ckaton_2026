"""
Train Linear Regression with Cross-Validation using ALL features.

This script uses k-fold cross-validation to get more robust performance estimates
...
def main():
    ...
    print("\nCreating pipeline: StandardScaler + LinearRegression")
    pipeline = Pipeline([
    ...
    model_filename = os.path.join(save_dir, f"linear_regression_cv_all_features_{timestamp}.pkl")
    ...
    # Save CV results
    results_filename = os.path.join(save_dir, f"cv_results_linear_regression_{timestamp}.csv")
